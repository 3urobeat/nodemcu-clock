/*
  ...
  without noun "letter", without preposition "with"
  
  for naming see also https://www.utf8-zeichentabelle.de/unicode-utf8-table.pl
  
  sort in this file is
    alphabet
      capital/small
        utf-8
    special characters
  ...
  Version
  2022-08-31 added some letters for Turkish
  2022-07-30 added some vocals, resorted
...
const uint8_t latin_small_a_grave[]         PROGMEM = {0b01000, 0b00100, 0b01110, 0b00001, 0b01111, 0b10001, 0b01111, 0}; // {0xc3a0, 'a'}, // à  LATIN SMALL LETTER A WITH GRAVE
//const uint8_t latin_small_a_grave[]       PROGMEM = {0b01000, 0b00100, 0b00000, 0b01110, 0b10001, 0b10011, 0b01101, 0}; // {0xc3a0, 'a'}, // à  LATIN SMALL LETTER A WITH GRAVE  - Variant with smaller a
...
const uint8_t latin_small_e_acute[]         PROGMEM = {0b00010, 0b00100, 0b01110, 0b10001, 0b11111, 0b10000, 0b01110, 0}; // {0xc3a9, 'e'}, // é  LATIN SMALL LETTER E WITH ACUTE
const uint8_t latin_small_e_grave[]         PROGMEM = {0b01000, 0b00100, 0b01110, 0b10001, 0b11111, 0b10000, 0b01110, 0}; // {0xc3a8, 'e'}, // è  LATIN SMALL LETTER E WITH GRAVE
const uint8_t latin_small_e_circumflex[]    PROGMEM = {0b00100, 0b01010, 0b01110, 0b10001, 0b11111, 0b10000, 0b01110, 0}; // {0xc3aa, 'e'}, // ê  LATIN SMALL LETTER E WITH CIRCUMFLEX
...
const uint8_t latin_capital_g_breve[]       PROGMEM = {0b01110, 0b00000, 0b01110, 0b10000, 0b10110, 0b10010, 0b01110, 0}; // {0xc49e, 'G'}, // Ğ  LATIN CAPITAL LETTER G WITH BREVE
const uint8_t latin_small_g_breve[]         PROGMEM = {0b01110, 0b00000, 0b01110, 0b10010, 0b01110, 0b00010, 0b11100, 0}; // {0xc49f, 'g'}, // ğ  LATIN SMALL LETTER G WITH BREVE
...
const uint8_t latin_capital_i_dot_above[]   PROGMEM = {0b00100, 0b00000, 0b01110, 0b00100, 0b00100, 0b00100, 0b01110, 0}; // {0xC4B0, 'I'}, // İ  LATIN CAPITAL LETTER I WITH DOT ABOVE
const uint8_t latin_small_i_dotless[]       PROGMEM = {0b00000, 0b00000, 0b01100, 0b00100, 0b00100, 0b00100, 0b01110, 0}; // {0xc4b1, 'i'}, // ı  LATIN SMALL LETTER DOTLESS I
...
const uint8_t latin_capital_s_cedilla[]     PROGMEM = {0b01111, 0b10000, 0b01110, 0b00001, 0b11110, 0b00010, 0b00110 ,0}; // {0xc59e, 'S'}, // Ş  LATIN CAPITAL LETTER S WITH CEDILLA
const uint8_t latin_small_s_cedilla[]       PROGMEM = {0b01110, 0b01000, 0b01110, 0b00010, 0b01110, 0b00010, 0b00110 ,0}; // {0xc59f, 's'}, // ş  LATIN SMALL LETTER S WITH CEDILLA
...
const uint8_t latin_small_u_circumflex[]    PROGMEM = {0b00100, 0b01010, 0b00000, 0b10001, 0b10001, 0b10011, 0b01101 ,0}; // {0xc3bb, 'u'}, // û  LATIN SMALL LETTER U WITH CIRCUMFLEX
const uint8_t latin_small_u_grave[]         PROGMEM = {0b01000, 0b00100, 0b00000, 0b10001, 0b10001, 0b10011, 0b01101 ,0}; // {0xc3b9, 'u'}, // ù  LATIN SMALL LETTER U WITH GRAVE
...
const uint8_t latin_small_g_descender[]     PROGMEM = {0b00000, 0b00000, 0b01110, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110};
const uint8_t latin_small_j_descender[]     PROGMEM = {0b00001, 0b00000, 0b00001, 0b00001, 0b00001, 0b00001, 0b01001, 0b00110};
const uint8_t latin_small_p_descender[]     PROGMEM = {0b00000, 0b00000, 0b01110, 0b10001, 0b10001, 0b11110, 0b10000, 0b10000};
const uint8_t latin_small_q_descender[]     PROGMEM = {0b00000, 0b00000, 0b01110, 0b10001, 0b10001, 0b01111, 0b00001, 0b00001}; 
//const uint8_t latin_small_q_descender[]   PROGMEM = {0b00000, 0b00000, 0b00110, 0b01001, 0b01001, 0b00111, 0b00001, 0b00001}; // Variant slimmer
const uint8_t latin_small_y_descender[]     PROGMEM = {0b00000, 0b00000, 0b10001, 0b10001, 0b10001, 0b01111, 0b00001, 0b01110}; 
//const uint8_t latin_small_y_descender[]   PROGMEM = {0b00000, 0b00000, 0b01001, 0b01001, 0b01001, 0b00111, 0b00001, 0b01110}; // Variant slimmer
